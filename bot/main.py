...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "переставлю номера и при необходимости добавлю тянучки. Важные правила! актеры должны иметь теги %, !, (гк) точно в таком формате. Так же, придерживайтесь стандартного формата стобцов."
    )
